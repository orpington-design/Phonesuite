...
import { ArrowLeft, Package, Check, Smartphone } from 'lucide-react';
    ...
    <div className="mobile-portal-wrapper">
      <div className="mobile-app-shell">
        ...
        >
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '0.94rem', fontWeight: '900', color: '#ffffff', letterSpacing: '-0.02em' }}>
              {language === 'pt' ? 'Pedidos Online' : 'Online Orders'}
            </div>
        ...
        <main className="mobile-scroll-body" style={{ padding: '1rem' }}>
          <StaffOrdersTab tenant={tenant} branch={branch} tenantSlug={tenantSlug} />
        </main>
